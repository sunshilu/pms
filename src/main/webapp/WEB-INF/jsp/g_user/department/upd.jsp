	...
	<body>
			...
			<form class="layui-form" lay-filter="upduser" method="post">
				<div class="layui-form-item">
					...
					<div class="layui-input-inline">
						<input type="text" name="code" readonly lay-verify="required" placeholder="请输入账号" autocomplete="off" class="layui-input">
					</div>
				</div>
				<div class="layui-form-item">
				...
				<div class="layui-form-item">
					...
					<div class="layui-input-inline">
						<input type="button" class="layui-btn" lay-submit lay-filter="updUser" value="确定" /> <input type="button" class="layui-btn"
		...
		<script type="text/javascript">
			...
			function init() {
				...
				$.ajax({
					url: con.app + '/department/initUpd',
					data: {
						code: code
					},
					dataType: 'json',
					...
					success: function(data) {
						form.val("upduser", {
							...
							parentDepart: data.parentDepart,
						});
						form.render();
					}
				});
			...
			formSubmit('/department/upd', 'submit(updUser)', 'text',
				function(data) {
					if (data == 1) {
						layer.msg('修改成功');
						closeThis(1000);
